...
import { Container, ToastContainer, Toast, Image, ButtonGroup, Row, Col, ToggleButton } from 'react-bootstrap'
...
const Home = () => {
  ...
  return (
    <Container className="g-0 vw-75 vh-100 d-flex flex-column pt-13 align-items-center overflow-auto">
